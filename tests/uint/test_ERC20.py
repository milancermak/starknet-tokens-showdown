...
def contract_classes():
    ...
    erc20_cls = get_contract_class('contracts/uint/ERC20Mintable.cairo', is_path=True)
...
async def test_transferFrom(erc20_factory):
    ...
    print("Uint256 test_transferFrom")
    print(return_bool.call_info.execution_resources)
    print("Gas cost:", calculate_gas_cost(return_bool))
